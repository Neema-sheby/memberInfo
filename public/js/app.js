...
var member = document.querySelector(".member"); // HIDE OR SHOW THE MEMBER DETAILS

member.addEventListener("click", function (e) {
  e.preventDefault();
  var btn = e.target.parentElement.parentElement.querySelector('.member__name').querySelector('.btn__member-details');
  var details = e.target.parentElement.parentElement.querySelector('.member__details');
  console.log(btn);

  if (e.target === btn) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()(details).slideToggle();
  } else {
    return;
  }
});
